 ...
 * @author cherra
 */
@WebServlet(name = "AceptAssociationRequestServlet", urlPatterns = {"/AceptAssociationRequestServlet"})
public class AceptAssociationRequestServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(user != null){
            ...
            List<User> usersAssociation = association.getUserList();
            usersAssociation.add(sender);
            association.setUserList(usersAssociation);
